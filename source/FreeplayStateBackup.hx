...
class FreeplayStateBackup extends MusicBeatState
{
	var songs:Array<SongMetadata> = [];
	var blacky:FlxSprite = new FlxSprite().makeGraphic(FlxG.width * 3, FlxG.height * 3, FlxColor.BLACK);
