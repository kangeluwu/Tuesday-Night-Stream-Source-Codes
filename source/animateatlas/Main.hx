...
class Main extends Sprite {
	...
	public function new() {
		...
		var animationData:AnimationData = Json.parse(Assets.getText("windose_data/TEST/Animation.json"));
		var atlasData:AtlasData = Json.parse(Assets.getText("windose_data/TEST/spritemap.json"));
		var bitmapData:BitmapData = Assets.getBitmapData("windose_data/TEST/spritemap.png");
