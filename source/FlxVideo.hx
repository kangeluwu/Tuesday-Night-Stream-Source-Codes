...
class FlxVideo {
	...
	public var bitmap:VlcBitmap = null;
	...
	public var nodispose:Bool = false;
	...
	public var vol:Float = FlxG.sound.volume + 0.3;
	function update(e:Event)
	{
		...
		bitmap.volume = vol; // shitty volume fix. then make it louder.
