...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "precacheImage", function(name:String, allowGPU:Bool = true) {
			Paths.returnGraphic(name, allowGPU);
		});
		...
		Lua_helper.add_callback(lua, "luaCharacterdExists", function(tag:String) {
			return PlayState.instance.modchartCharacters.exists(tag);
		});
		...
		Lua_helper.add_callback(lua, "initSaveData", function(name:String, ?folder:String = 'raincandyenginemods') {
